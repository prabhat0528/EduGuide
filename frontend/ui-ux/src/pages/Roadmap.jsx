    ...
    <div className="max-w-4xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="text-center space-y-3 mb-12">
        ...
        <p className="text-slate-400 max-w-xl mx-auto">
          We've broken down your goal into manageable weekly milestones.
        </p>
      </div>
...
const Roadmap = () => {
  ...
  const generateRoadmap = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Internal Server Error. Check if your backend schema matches the data sent.");
    } finally {
      setLoading(false);
    }
  };
